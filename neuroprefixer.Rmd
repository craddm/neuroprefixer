...
# This is for removing headlines with words that are likely to produce tasteless headlines; deactivated while I'm still manually vetting the generated headlines
#bannedWords <- c("murder","killed","deadly")
#headlines <- headlines[- grep(paste(bannedWords,collapse="|"),headlines)]
